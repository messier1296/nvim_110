...
- `jj` / `ｊｊ` / `っj` / `っｊ` / `<C-c>` で Insert mode から Normal mode へ戻る
...
| `jj` / `ｊｊ` / `っj` / `っｊ` / `<C-c>` | Insert mode から Normal mode へ戻る |
...
- `jj` / `ｊｊ` / `っj` / `っｊ` / `<C-c>` to leave Insert mode
...
| `jj` / `ｊｊ` / `っj` / `っｊ` / `<C-c>` | Leave Insert mode |
